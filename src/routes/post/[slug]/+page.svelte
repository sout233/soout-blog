...
<a class="fixed bottom-4 left-4" href="/">
...
<div bind:this={contentNode}>
    ...
    <header
        class="noto grid-bg mx-2 mt-10 max-w-2xl rounded-4xl bg-black p-4 text-base-300 shadow-2xl transition-all duration-300 hover:rounded-none hover:p-0 hover:shadow-none md:mx-auto"
    >
    ...
    <article
        class="noto mx-auto prose space-y-0 p-4 pt-10 lg:prose-lg prose-headings:my-4 prose-p:my-2"
    >
